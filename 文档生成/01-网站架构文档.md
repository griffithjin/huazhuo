...
**日期**: 2026-06-03  
**作者**: 小鹿 🦌  
**适用范围**: 中文版 (tokenhub.cn) + 英文版 (tokenhub.ai)  
...
| 中文页面 | 英文页面 | 说明 |
|----------|----------|------|
| `tokenhub.cn/` | `tokenhub.ai/` | 首页，内容本地化 |
| `tokenhub.cn/pricing` | `tokenhub.ai/pricing` | 套餐商城，货币/套餐本地化 |
| `tokenhub.cn/models` | `tokenhub.ai/models` | 模型广场，模型列表一致 |
| `tokenhub.cn/playground` | `tokenhub.ai/playground` | 在线体验，语言默认跟随站点 |
| `tokenhub.cn/user/*` | `tokenhub.ai/user/*` | 用户中心，同一套UI |
| `tokenhub.cn/help/*` | `tokenhub.ai/help/*` | 帮助文档，内容翻译 |
| `tokenhub.cn/blog` | `tokenhub.ai/blog` | 博客，内容独立运营 |
| `tokenhub.cn/case-studies` | `tokenhub.ai/case-studies` | 案例，案例本地化 |
| `tokenhub.cn/about` | `tokenhub.ai/about` | 关于我们，团队/联系方式本地化 |
| `tokenhub.cn/green-ai` | `tokenhub.ai/green-ai` | 绿色AI，全球统一叙事 |
| `tokenhub.cn/affiliate` | `tokenhub.ai/affiliate` | 推荐计划，佣金货币本地化 |
| `partner.tokenhub.cn/*` | `partner.tokenhub.ai/*` | 渠道后台，同一套系统 |
| `admin.tokenhub.cn/*` | `admin.tokenhub.ai/*` | 管理后台，同一套系统 |
...
| 多语言 | 英文版独立域名 | `tokenhub.ai/pricing` |
